/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi.apps\packages\wizzi-heroku\.wizzi-override\src\middlewares\wizziCdn.ts.ittf
*/
...
function _renderCdn(owner: string, cdnName: string, request: Request, response: Response, next: Function) {
    ...
    resourceApi.getCdnResource(owner, cdnName).then((result: any) => {
