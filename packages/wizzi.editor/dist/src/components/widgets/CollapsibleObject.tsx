/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi.webapp\packages\wizzi.editor\.wizzi\src\components\widgets\CollapsibleObject.tsx.ittf
    utc time: Tue, 28 Jun 2022 14:08:24 GMT
*/
import {StyleSheet, css} from 'aphrodite';
import * as React from 'react';

export type CollapsibleObjectProps = { 
    object: any;
    label?: string;
};
...
export class CollapsibleObject extends React.Component<CollapsibleObjectProps, State> {
    state = {
        isExpanded: false
    }
    ;
