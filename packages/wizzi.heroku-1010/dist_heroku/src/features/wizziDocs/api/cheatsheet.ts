                                ...
                                for (k=0; k<k_len; k++) {
                                    ...
                                    if ((item.n === 'is-error' || item.n === 'isError') && item.v == 'true') {
                                        ...
                                        if (item.children.length == 1) {
                                            ...
                                            if (((result.schema === 'json' || result.schema === 'yaml') && (item.children[0].n === '{' || item.children[0].n === '[')) || item.children[0].n === wizziMaps.ittfRootFromSchema(result.schema) || wizziMaps.ittfRootFromSchema(result.schema) === 'any' || isError) {
                ...
                (function next() {
                    ...
                    pretty.prettifyIttfHtmlFromString(item.ittf, (err: any, pretty: any) => {
                        ...
                        if (item.render === 'script') {
                            ...
                            wizziProds.mTree('index.ittf.ittf', {
                                ['index.ittf.ittf']: {
                                    type: 'CODE', 
                                    contents: item.ittfWrapped
                                 }
                                ...
                                if (result.__is_error) {
                                    ...
                                    item.generated = verify.htmlEscape(result.mTreeIttf);
                                }
                                item.generated = item.generated ? item.generated.trim() : 'No result. Something went wrong!';
                                next();
                            }
