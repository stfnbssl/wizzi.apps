...
import { JsonComponents } from "@wizzi/repo";
...
async function createFilesystemFactoryWithParameters(pluginsBaseFolder, plugins, globalContext) {
  return new Promise(
    (resolve2, reject) => wizzi.fsFactory({
      repo: {
...
async function createJsonFsAndFactory(files, factoryPlugins, metaPlugins, globalContext) {
  ...
  return new Promise(
    (resolve2, reject) => JsonComponents.createJsonFs(
      jsonDocuments,
    ...
    async (resolve2, reject) => {
      ...
      try {
        ...
        jsonwf.wf.generateFolderArtifacts(
          constants2.packiFilePrefix + sourceFolderUri,
          {
            modelRequestContext: context,
            artifactRequestContext: context
          },
          {
            destFolder: constants2.packiFilePrefix + destFolderUri,
            deep: true,
          ...
          (err, result) => {
            ...
            jsonwf.wf.fileService.getFiles(
              constants2.packiFilePrefix + destFolderUri,
              {
                deep: true,
  ...
  return new Promise(
    async (resolve2, reject) => {
      ...
      try {
        ...
        ;
        metaCtx.__wz_fsc = new wizzi2.FactoryServiceContext();
  ...
  return new Promise(
    async (resolve2, reject) => {
      try {
        ...
        wf.executeJob(
          {
            name: request.wzjobName || path2.basename(request.wzjobIttfDocumentUri),
...
async function scanIttfDocumentFs(filePath, rootFolder) {
  return new Promise(
    (resolve2, reject) => ittfScanner.scanIttfDocument(
      filePath,
      {
        rootFolder
      },
...
async function scanIttfFolder(filePath, rootFolder) {
  return new Promise(
    (resolve2, reject) => ittfScanner.browseFolder(
      filePath,
      {
        rootFolder
      },
...
function resolveContext(contextItem) {
  if (contextItem.source == "json-fsIttf") {
    ...
    return new Promise(
      (resolve2, reject) => {
        const json2 = file.readJSON(contextItem.path);
        resolve2(json2);
      }
    );
...
var ArtifactProductionSchema = new Schema({
  owner: String,
  name: String,
  description: String,
  wizziSchema: String,
...
function GetArtifactProductionModel() {
  if (!ArtifactProductionModel) {
    ArtifactProductionModel = model("ArtifactProduction", ArtifactProductionSchema);
  }
  return ArtifactProductionModel;
}
var ArtifactProductionModelBuilder = {
  buildModel: (options) => ArtifactProductionModel = model("ArtifactProduction", ArtifactProductionSchema),
...
var PackageProductionSchema = new Schema2({
  owner: String,
  name: String,
  description: String,
  packiFiles: String,
...
function GetPackageProductionModel() {
  if (!PackageProductionModel) {
    PackageProductionModel = model2("PackageProduction", PackageProductionSchema);
  }
  return PackageProductionModel;
}
var PackageProductionModelBuilder = {
  buildModel: (options) => PackageProductionModel = model2("PackageProduction", PackageProductionSchema),
  applyExtraSetup: (options) => {
  }
};
...
var PluginProductionSchema = new Schema3({
  owner: String,
  name: String,
  description: String,
  packiFiles: String,
...
function GetPluginProductionModel() {
  if (!PluginProductionModel) {
    PluginProductionModel = model3("PluginProduction", PluginProductionSchema);
  }
  return PluginProductionModel;
}
var PluginProductionModelBuilder = {
  buildModel: (options) => PluginProductionModel = model3("PluginProduction", PluginProductionSchema),
  applyExtraSetup: (options) => {
  }
};
...
var MetaProductionSchema = new Schema4({
  owner: String,
  name: String,
  description: String,
  packiFiles: String,
...
function GetMetaProductionModel() {
  if (!MetaProductionModel) {
    MetaProductionModel = model4("MetaProduction", MetaProductionSchema);
  }
  return MetaProductionModel;
}
var MetaProductionModelBuilder = {
  buildModel: (options) => MetaProductionModel = model4("MetaProduction", MetaProductionSchema),
  applyExtraSetup: (options) => {
  }
};
...
var TFolderProductionSchema = new Schema5({
  owner: String,
  name: String,
  description: String,
  packiFiles: String,
...
function GetTFolderProductionModel() {
  if (!TFolderProductionModel) {
    TFolderProductionModel = model5("TFolder", TFolderProductionSchema);
  }
  return TFolderProductionModel;
}
var TFolderProductionModelBuilder = {
  buildModel: (options) => TFolderProductionModel = model5("TFolder", TFolderProductionSchema),
  applyExtraSetup: (options) => {
  }
};
...
var JobProductionSchema = new Schema6({
  owner: String,
  name: String,
  description: String,
  packiFiles: String,
...
function GetJobProductionModel() {
  if (!JobProductionModel) {
    JobProductionModel = model6("Job", JobProductionSchema);
  }
  return JobProductionModel;
}
var JobProductionModelBuilder = {
  buildModel: (options) => JobProductionModel = model6("Job", JobProductionSchema),
  applyExtraSetup: (options) => {
  }
};
...
import ReactDOMServer3 from "react-dom/server";
...
function PageFormDocument(props) {
  ...
  return /* @__PURE__ */ React.createElement("html", null, /* @__PURE__ */ React.createElement("head", null, /* @__PURE__ */ React.createElement("meta", { charSet: "utf-8" }), /* @__PURE__ */ React.createElement("meta", { httpEquiv: "X-UA-Compatible", content: "IE=edge" }), /* @__PURE__ */ React.createElement("meta", { name: "viewport", content: "width=device-width,minimum-scale=1,initial-scale=1" }), /* @__PURE__ */ React.createElement("link", { rel: "stylesheet", href: "https://fonts.googleapis.com/css?family=Source+Sans+Pro:400,300,500,600" }), /* @__PURE__ */ React.createElement("link", { rel: "stylesheet", href: "https://cdn.jsdelivr.net/npm/normalize.css@8.0.1/normalize.min.css" }), /* @__PURE__ */ React.createElement("link", { rel: "stylesheet", href: "/ittf/css/main.css.ittf" }), /* @__PURE__ */ React.createElement("script", { src: "https://bundle.run/buffer@6.0.3" }), /* @__PURE__ */ React.createElement("style", { type: "text/css", dangerouslySetInnerHTML: {
    __html: PageCss
  } }), /* @__PURE__ */ React.createElement("script", { dangerouslySetInnerHTML: {
  ...
  } })), /* @__PURE__ */ React.createElement("body", null, /* @__PURE__ */ React.createElement("div", { className: "flex-row space-between bg-color-header color-header align-items-center", id: "__main_navbar" }, /* @__PURE__ */ React.createElement("div", { className: "flex-row" }, /* @__PURE__ */ React.createElement("a", { className: "color-header font-x font-w-s", href: "/" }, /* @__PURE__ */ React.createElement("div", { style: { width: "80px", marginTop: "5px", marginLeft: "20px" } }))), /* @__PURE__ */ React.createElement("div", { className: "flex-row" }, /* @__PURE__ */ React.createElement("a", { className: "m-s color-header font-l font-w-xxl", href: "/ittf/site/starter.html.ittf" }, "Starter"), /* @__PURE__ */ React.createElement("a", { className: "m-s color-header font-l font-w-xxl", href: "/ittf/site/lab.html.ittf" }, "Lab"), /* @__PURE__ */ React.createElement("div", { className: "m-s p-s color-header-inverse bg-color-header-inverse font-l font-w-xxl" }, "Productions"), /* @__PURE__ */ React.createElement("a", { className: "m-s color-header font-l font-w-xxl", href: "/ittf/site/project.html.ittf" }, "Project")), /* @__PURE__ */ React.createElement("div", { className: "flex-row" }, /* @__PURE__ */ React.createElement("a", { className: "m-s color-header font-l font-w-xxl", href: "/ittf/site/docs.html.ittf" }, "Docs")), /* @__PURE__ */ React.createElement("div", { className: "flex-row m-r-x" }, /* @__PURE__ */ React.createElement("a", { className: "m-s color-header font-l font-w-xxl", href: "/profile" }, "Profile"), /* @__PURE__ */ React.createElement("a", { className: "m-s color-header font-l font-w-xxl", href: "/logout" }, "Log Out"))), /* @__PURE__ */ React.createElement("section", { id: "root" }), /* @__PURE__ */ React.createElement("script", { src: "/public/pageforms/main.bundle.js" })));
}
...
function EditorDocument(props) {
  ...
  return /* @__PURE__ */ React2.createElement("html", null, /* @__PURE__ */ React2.createElement("head", null, /* @__PURE__ */ React2.createElement("meta", { charSet: "utf-8" }), /* @__PURE__ */ React2.createElement("meta", { httpEquiv: "X-UA-Compatible", content: "IE=edge" }), /* @__PURE__ */ React2.createElement("meta", { name: "viewport", content: "width=device-width,minimum-scale=1,initial-scale=1" }), /* @__PURE__ */ React2.createElement("link", { rel: "stylesheet", href: "https://fonts.googleapis.com/css?family=Source+Sans+Pro:400,300,500,600" }), /* @__PURE__ */ React2.createElement("link", { rel: "stylesheet", href: "https://cdn.jsdelivr.net/npm/normalize.css@8.0.1/normalize.min.css" }), /* @__PURE__ */ React2.createElement("style", { type: "text/css", dangerouslySetInnerHTML: {
    __html: PageCss2
  } }), /* @__PURE__ */ React2.createElement("script", { dangerouslySetInnerHTML: {
    __html: `  window.__INITIAL_DATA__ = ${jsesc2({
      data,
      loggedUser,
      queryParams
    }, {
...
`
  } })), /* @__PURE__ */ React2.createElement("body", null, /* @__PURE__ */ React2.createElement("section", { id: "root" }), /* @__PURE__ */ React2.createElement("script", { defer: true, src: "/public/packi/app.bundle.js" }), /* @__PURE__ */ React2.createElement("script", { defer: true, src: "/public/packi/editor.worker.bundle.js" }), /* @__PURE__ */ React2.createElement("script", { defer: true, src: "/public/packi/json.worker.bundle.js" }), /* @__PURE__ */ React2.createElement("script", { defer: true, src: "/public/packi/css.worker.bundle.js" }), /* @__PURE__ */ React2.createElement("script", { defer: true, src: "/public/packi/html.worker.bundle.js" }), /* @__PURE__ */ React2.createElement("script", { defer: true, src: "/public/packi/ts.worker.bundle.js" })));
}

// src/features/packi/controllers/packiEditing.tsx
function renderPackiEditor(req, res, packiItemObject, loggedUser, queryParams) {
  const index = "<!DOCTYPE html>" + ReactDOMServer.renderToStaticMarkup(
    /* @__PURE__ */ React3.createElement(EditorDocument, { data: packiItemObject, queryParams, loggedUser })
  );
...
function renderPackiEditor2(req, res, packiItemObject, loggedUser, queryParams) {
  const index = "<!DOCTYPE html>" + ReactDOMServer2.renderToStaticMarkup(
    /* @__PURE__ */ React4.createElement(EditorDocument, { data: packiItemObject, queryParams, loggedUser })
  );
  res.set("Content-Type", "text/html");
  res.set("Content-Length", index.length.toString());
  res.send(index);
...
var metaProductionCache = new NodeCache({
  stdTTL: 120,
  checkperiod: 60
});
...
var artifactProductionCache = new NodeCache2({
  stdTTL: 120,
  checkperiod: 60
});
...
function renderPageForm(req, res, data, queryParams) {
  const index = "<!DOCTYPE html>" + ReactDOMServer3.renderToStaticMarkup(
    /* @__PURE__ */ React5.createElement(PageFormDocument, { data, queryParams })
  );
  res.set("Content-Type", "text/html");
  res.set("Content-Length", index.length.toString());
  res.send(index);
...
import NodeCache3 from "node-cache";
var myname5 = "features.production.api.PackageProduction";
var packageProductionCache = new NodeCache3({
  stdTTL: 120,
  checkperiod: 60
});
...
function renderPageForm2(req, res, data, queryParams) {
  const index = "<!DOCTYPE html>" + ReactDOMServer4.renderToStaticMarkup(
    /* @__PURE__ */ React6.createElement(PageFormDocument, { data, queryParams })
  );
  res.set("Content-Type", "text/html");
  res.set("Content-Length", index.length.toString());
  res.send(index);
...
import NodeCache4 from "node-cache";
var myname6 = "features.production.api.PluginProduction";
var pluginProductionCache = new NodeCache4({
  stdTTL: 120,
  checkperiod: 60
});
...
function renderPageForm3(req, res, data, queryParams) {
  const index = "<!DOCTYPE html>" + ReactDOMServer5.renderToStaticMarkup(
    /* @__PURE__ */ React7.createElement(PageFormDocument, { data, queryParams })
  );
  res.set("Content-Type", "text/html");
  res.set("Content-Length", index.length.toString());
  res.send(index);
...
function renderPageForm4(req, res, data, queryParams) {
  const index = "<!DOCTYPE html>" + ReactDOMServer6.renderToStaticMarkup(
    /* @__PURE__ */ React8.createElement(PageFormDocument, { data, queryParams })
  );
  res.set("Content-Type", "text/html");
  res.set("Content-Length", index.length.toString());
  res.send(index);
...
import NodeCache5 from "node-cache";
var myname7 = "features.production.api.TFolderProduction";
var tFolderProductionCache = new NodeCache5({
  stdTTL: 120,
  checkperiod: 60
});
...
function renderPageForm5(req, res, data, queryParams) {
  const index = "<!DOCTYPE html>" + ReactDOMServer7.renderToStaticMarkup(
    /* @__PURE__ */ React9.createElement(PageFormDocument, { data, queryParams })
  );
  res.set("Content-Type", "text/html");
  res.set("Content-Length", index.length.toString());
  res.send(index);
...
import NodeCache6 from "node-cache";
var myname8 = "features.production.api.JobProduction";
var jobProductionCache = new NodeCache6({
  stdTTL: 120,
  checkperiod: 60
});
...
function renderPageForm6(req, res, data, queryParams) {
  const index = "<!DOCTYPE html>" + ReactDOMServer8.renderToStaticMarkup(
    /* @__PURE__ */ React10.createElement(PageFormDocument, { data, queryParams })
  );
  res.set("Content-Type", "text/html");
  res.set("Content-Length", index.length.toString());
  res.send(index);
...
async function createMetaCtx(options) {
  return new Promise(
    ...
    (resolve2, reject) => {
      ...
      if (verify3.isEmpty(options.metaCtxFilepath)) {
