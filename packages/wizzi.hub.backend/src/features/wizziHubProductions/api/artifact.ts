/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi.demo\packages\ts.express.lab\.wizzi\src\features\wizziHubProductions\api\artifact.ts.ittf
    ...
    return new Promise(// TODO config.packiConfigPath shoul become constants.packiConfigPath
        (resolve, reject) => {
            ...
            const obj = {
                ...
                packiConfig: ap_packiFiles_object[config.packiConfigPath], 
                packiConfigObj: null
             };
            ...
            if (loadPackiConfig) {
                if (!obj.packiConfig) {
                    return reject({
                            message: 'Missing file ' + config.packiConfigPath + ' in ArtifactProduction'
                         });
                }
...
*/
async function getArtifactContext(owner: string, queryContextString: string, progressiveContext?: any) {
    progressiveContext = progressiveContext || {};
    return new Promise((resolve, reject) => {
...
export async function getArtifactContextItem(owner: string, queryContextString: string, progressiveContext?: any) {
    progressiveContext = progressiveContext || {};
    /**
