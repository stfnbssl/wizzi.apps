/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi.demo\packages\ts.express.lab\.wizzi\src\features\wizziHubProductions\api\job.ts.ittf
    ...
    return new Promise(// TODO config.packiConfigPath shoul become constants.packiConfigPath
        (resolve, reject) => {
            ...
            const obj = {
                ...
                packiConfig: job_packiFiles_object[config.packiConfigPath], 
                packiConfigObj: null
             };
            ...
            if (loadPackiConfig) {
                if (!obj.packiConfig) {
                    return reject({
                            message: 'Missing file ' + config.packiConfigPath + ' in JobProduction'
                         });
                }
