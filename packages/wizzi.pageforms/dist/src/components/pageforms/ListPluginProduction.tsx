...
export interface ListPluginProductionProps {
    data: any;
}

type ListPluginProductionState = { 
    l_plugins: any[];
    l_search: string;
    l_sort: string;
};
...
export class ListPluginProduction extends Component<ListPluginProductionProps, ListPluginProductionState> {
    constructor(props: ListPluginProductionProps) {
        super(props);
    }
    state: ListPluginProductionState = {
        l_plugins: [
             ...
             className="flex-column width-full">
                     ...
                     className="flex-row m-xxl">
                        <div
                         className="flex-column m-s">
                            <a
                             className="button p-s radius-m bg-success color-white border-s font-m font-w-xxl" href="/plugin/new">
                                <div
                                 className="flex-row">
                                    <AddDocumentIcon
                                     height="16" width="16" />
                ...
                </div>
                {
                    this.state.l_plugins
                     && this.state.l_plugins.map((item: any, ndx: number) => {
                                        ...
                                        <div
                                         className="flex-column width-full">
                                            <div
                                             className="font-xl">
                                                <a
                                                 href={'/~~/l/stfnbssl/' + item.name} title={item.description}>
                                                {item.name}
                                                </a>
                                            </div>
                                        </div>
                                        <div
                                         className="flex-row">
                                            <div
                                             className="flex-column m-s">
                                                <a
                                                 className="button p-s radius-m bg-warning color-white border-s font-m font-w-xxl" href={'/plugin/update/' + item.id}>
                                                    <div
                                                     className="flex-row">
                                                        <AddDocumentIcon
                                                         height="16" width="16" />
                                            ...
                                            <div
                                             className="flex-column m-s">
                                                <a
                                                 className="button p-s radius-m bg-error color-white border-s font-m font-w-xxl" href={'/plugin/delete/' + item.id}>
                                                    <div
                                                     className="flex-row">
                                                        <AddDocumentIcon
                                                         height="16" width="16" />
...
export default ListPluginProduction;
