...
let EditorViewComp = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(EditorViewComp, [{
    ...
    function render() {
      ...
      const testPreviewURL = "".concat("http://localhost:5100", "/~/").concat(encodeURIComponent(owner), "/").concat(encodeURIComponent(name));
  ...
  _createClass(UserMenuComp, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1__.createElement("div", {
        ...
        actions: loggedUser ? [{
          label: 'Artifacts',
          handler: () => window.open("".concat("http://localhost:5100", "/productions/artifacts"))
        }, {
          label: 'Packages',
          handler: () => window.open("".concat("http://localhost:5100", "/productions/packages"))
        }, {
          label: 'Metas',
          handler: () => window.open("".concat("http://localhost:5100", "/productions/metas"))
        }, {
          label: 'tFolders',
          handler: () => window.open("".concat("http://localhost:5100", "/productions/tfolders"))
        }, {
          label: 'Settings',
          handler: () => window.open("".concat("http://localhost:5100", "/settings"))
        }] : [{
...
function getPageMetadata(props) {
  ...
  const url = "".concat(({"NODE_ENV":"development","SERVER_URL":"http://localhost:5100","API_SERVER_URL":"http://localhost:5100","PACKI_SEGMENT_KEY":"","PACKI_AMPLITUDE_KEY":"","PACKI_WEBPLAYER_URL":"","DEPLOY_ENVIRONMENT":"staging","BUILD_TIMESTAMP":1712841887534}).PACKI_SERVER_URL).concat(props.id ? "/".concat(props.id) : '', "\n    ");
