...
postcss.plugin = function plugin(name, initializer) {
  if (console && console.warn) {
    ...
    if (({"NODE_ENV":"development","SERVER_URL":"http://localhost:5100","API_SERVER_URL":"http://localhost:5100","PACKI_SEGMENT_KEY":"","PACKI_AMPLITUDE_KEY":"","PACKI_WEBPLAYER_URL":"","DEPLOY_ENVIRONMENT":"staging","BUILD_TIMESTAMP":1712841887534}).LANG && ({"NODE_ENV":"development","SERVER_URL":"http://localhost:5100","API_SERVER_URL":"http://localhost:5100","PACKI_SEGMENT_KEY":"","PACKI_AMPLITUDE_KEY":"","PACKI_WEBPLAYER_URL":"","DEPLOY_ENVIRONMENT":"staging","BUILD_TIMESTAMP":1712841887534}).LANG.startsWith('cn')) {
      // istanbul ignore next
      console.warn(
        name +
