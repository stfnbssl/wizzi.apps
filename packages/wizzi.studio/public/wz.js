/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi.apps\packages\wizzi.studio\.wizzi\public\wz.js.ittf
*/
'use strict';
...
(function() {
    ...
    if (!window.wz.packi) {
        window.wz.packi = {
            apiUrl: "http://localhost:5100/api/v1/packi", 
...
(function() {
    ...
    if (!window.wz.production) {
        window.wz.production = {
            apiUrl: "http://localhost:5100/api/v1/production", 
            webUrl: "http://localhost:5100"
         };
    }
