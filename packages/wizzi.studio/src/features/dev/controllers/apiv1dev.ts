...
import {scanDevFolders} from '../api/index';
...
export class ApiV1DevController implements ControllerType {
    
    public path = '/api/v1/dev';
    
    public router = Router();
    
    
    initialize = (app: express.Application, initValues: AppInitializerType) => {
        console.log("[33m%s[0m", 'Entering ApiV1DevController.initialize');
        this.router.get('/scan', this.getDevScan);
    };
