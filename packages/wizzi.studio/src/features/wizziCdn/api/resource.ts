/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi.apps\packages\wizzi.studio\.wizzi\src\features\wizziCdn\api\resource.ts.ittf
...
export /**
    // console.log
        ...
        // name
*/
async function deleteWizziCdnResource(id: string, owner?: string, name?: string, contents?: string):  Promise<CRUDResult> {
