/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi.apps\packages\wizzi.studio\.wizzi\src\middlewares\static.ts.ittf
*/
...
export const StaticFilesMiddleware: MiddlewareType = (app: Application) => {
    ...
    console.log("[32m%s[0m", 'StaticFilesMiddleware. Folder served from ', path.resolve(__dirname, '..', '..', 'static'));
