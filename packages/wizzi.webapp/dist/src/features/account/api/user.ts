...
export // loog myname, 'createUserFromSignup', 'signupData', signupData
async function createUserFromSignup(signupData: SignupData):  Promise<CreateUserResult> {

    const User = GetUserModel();
    return new Promise((resolve, reject) => 
        
            validateUserNotUsed(signupData.wizziUserName, signupData.email).then(
            // loog myname, 'createUserFromSignup', 'validateUserNotUsed', result
            (result: ValidateUserNotUsedResult) => {
