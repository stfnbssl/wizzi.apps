/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi.apps\packages\wizzi.webapp\.wizzi\src\features\docs\api\cheatsheet.ts.ittf
    ...
    return new Promise((resolve, reject) => {
            ...
            (result: any) => {
                ...
                (function next() {
                    ...
                    pretty.prettifyIttfHtmlFromString(item.ittf, function(err: any, pretty: any) {
